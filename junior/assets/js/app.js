...
(function (global) {
  ...
  function applyTheme(t) { document.body.setAttribute("data-theme", t); try { localStorage.setItem("ipasjr_theme", t); localStorage.setItem("ipas_shared_theme", t); } catch (e) {} }
  (function () {
    try {
